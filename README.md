...
<div class="container">
    ...
    <section id="privacy">
        ...
        <h3>A. Local Gameplay Data</h3>
        <p>The Game is designed as a "local-first" experience. Core gameplay data, including your <strong>Traveler Logs</strong>, <strong>Save Slots</strong>, <strong>Neural Energy (EN)</strong> levels, and <strong>Modular Enhancements</strong>, are stored primarily on your device using local storage.</p>
        
        <h3>B. Cloud Synchronization & Social Data</h3>
